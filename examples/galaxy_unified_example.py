...
def example_csv_enmo():
    ...
    galaxy_handler = GalaxyDataHandler(
        ...
        data_columns=[
            "enmo_mg"
        ],  # Custom data column name (default would be ['enmo_mg'])
        verbose=True,
...
def example_with_defaults():
    ...
    galaxy_handler = GalaxyDataHandler(
        galaxy_file_path="../data/smartwatch/binary_data/", verbose=True
    )
...
if __name__ == "__main__":
    ...
    print(
        "Examples ready to run. Uncomment the desired example in the main block."
    )
